...
| B-147 | tech-debt | 文档一致性检查对齐 devlog 目录结构 | doing | P1 | S | v0.12.0 | RAG 团队 | docs/guides/testing.md, docs/README.md | 修复审计发现的 `scripts/check_docs_consistency.py` 仍依赖已删除 `docs/DEVLOG.md` 的问题；plan：docs/plans/B-147-docs-consistency-devlog.md |
