...
> Related：docs/architecture/overview.md, docs/architecture/backend/data.md, docs/architecture/backend/api.md, docs/architecture/decisions/ADR-007-qdrant-vector-store.md
...
- 正式设计文档：`docs/architecture/overview.md`
- 架构决策记录：`docs/architecture/decisions/ADR-007-qdrant-vector-store.md`
