...
| B-117 | research | MCP / 插件能力研究 | doing | P3 | S | backlog | RAG 团队 | docs/features/agent-tooling-mcp-research.md | 仅研究可控只读工具接入，不引入插件市场或任意命令执行；执行计划：docs/plans/B-117-mcp-plugin-research.md |
