...
|----|------|------|------|--------|------|--------|----------|------|
| B-170 | 文档 | 按 docs-template 扁平化重构文档体系 | doing | P1 | L | Codex | `features/README.md`、`design/architecture-overview.md` | 执行 plan：`plans/B-170-docs-template-flat-restructure.md`；仅迁移和校准文档职责，不改变 API、Schema 或运行时行为。 |
