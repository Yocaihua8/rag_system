...
- [ ] 梳理当前 URL 摘录边界、网页抓取能力差距和外部标准/依赖风险，形成研究文档。
...
| 内容 | 目标文档 | 是否完成 |
|------|----------|----------|
| 网页自动抓取研究结论和推荐边界 | `docs/features/web-crawling-research.md` | [ ] |
...
- **最后更新**：2026-06-30 00:38
- **进度**：已完成 0 / 3 项（见 § 3 勾选状态）
- **最新 commit**：N/A
- **代码状态**：`fix/b-08-concurrent-index`；工作区存在与本任务无关的未提交改动；B-119 尚未开始正式文档回流
- **下一步**：梳理当前 URL 摘录边界、网页抓取能力差距和外部标准/依赖风险，形成研究文档。
