...
| B-119 | research | 网页自动抓取研究 | doing | P3 | S | backlog | RAG 团队 | docs/features/web-crawling-research.md, docs/requirements/functional-modules.md | 当前 URL 来源只做人工粘贴正文；自动抓取涉及网络、权限和依赖，暂缓；执行计划：docs/plans/B-119-web-crawling-research.md |
