...
| POST | `/api/answer` | `project_id`、`question`、`tool_run_id`（可选） | `{"answer":"...","sources":[...],"mode":"local|api|fallback","provider":"local|deepseek|api|ollama","source_quality":...,"observability":...,"message":...,"tool_suggestion":...,"tool_context":...}` |
