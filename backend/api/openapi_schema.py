...
WEB_MVP_API_OPERATIONS: list[tuple[str, str, str]] = [
    ...
    ("POST", "/api/coach/learning-sessions/start", "Start or resume a coach learning session"),
    ("GET", "/api/coach/learning-sessions/current", "Get a current or historical coach learning session"),
    ("POST", "/api/coach/learning-sessions/transition", "Transition a coach learning session"),
    ("POST", "/api/coach/learning-sessions/attempts", "Submit a coach learning attempt"),
