...
> Related：ops/README.md, docs/architecture/backend/api.md, docs/architecture/overview.md, docs/BACKLOG.md
...
- `/openapi.json` 和 `docs/architecture/backend/api.md` 均包含新增 admin API。
- 相关 `tests/integration` / `tests/repository` 通过，或明确记录环境导致的失败。
