...
| B-07 | feature | 结果导出（Markdown / PDF） | doing | P3 | M | backlog | RAG 团队 | docs/features/result-export.md, docs/design/api-spec.md | `data/outputs/` 预留了输出目录，支持将生成结果导出为 Markdown / PDF；执行计划：docs/plans/B-07-result-export.md |
