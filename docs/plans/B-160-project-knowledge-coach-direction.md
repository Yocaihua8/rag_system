...
- [ ] 冻结产品定位、MVP、用例、功能边界与前端信息架构
- [ ] 冻结 v2 数据代际和 Obsidian 插件桥架构，新增 ADR-008/ADR-009
...
- **最后更新**：2026-07-23
- **进度**：已完成 0 / 3 项
- **最新 commit**：`ec236b1` — docs: 完成 Codex 视觉规范与术语收口
- **代码状态**：`feature/project-knowledge-coach-v2`；B-160 plan 与 BACKLOG 待提交
- **下一步**：冻结产品定位、MVP、用例、功能边界与前端信息架构
