...
| 内容 | 目标文档 | 是否完成 |
|------|----------|----------|
| B-141B API/state/layout 边界 | `docs/features/frontend-engineering.md` | [x] |
| Vue API/state/layout 架构说明 | `docs/design/architecture-overview.md` | [x] |
| Vue source 测试命令 | `docs/guides/testing.md` | [x] |
