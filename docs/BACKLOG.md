...
| B-145 | feature | Tauri 桌面壳 — Windows 打包验证 | doing | P1 | L | Tauri MVP 0 | RAG 团队 | docs/design/new-architecture-design.md §23, docs/features/desktop-packaging.md | PyInstaller 打包 FastAPI sidecar；Tauri WebView 加载 Vue dist；生成 .exe 安装包；系统托盘运行；plan：docs/plans/B-145-tauri-windows-packaging.md |
