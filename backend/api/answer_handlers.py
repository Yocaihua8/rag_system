...
from backend.domain.answers import compose_answer
from backend.api.support import project_retrieval_settings, source_quality
from backend.domain.llm import OpenAICompatibleChatClient, build_llm_client
from backend.domain.model_profiles import llm_config_from_profile
from backend.domain.models import AgentToolRun, ApiResponse, ModelProfile, SearchHit
...
def _openai_compatible_chat_client_class():
    api_module = sys.modules.get("backend.api.dispatch")
