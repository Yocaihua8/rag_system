...
from backend.knowledge_island.answers import compose_answer
from backend.knowledge_island.api_support import project_retrieval_settings, source_quality
from backend.knowledge_island.llm import OpenAICompatibleChatClient
from backend.knowledge_island.model_profiles import llm_config_from_profile
from backend.knowledge_island.models import AgentToolRun, ApiResponse, SearchHit
...
def _openai_compatible_chat_client_class():
    api_module = sys.modules.get("backend.knowledge_island.api")
