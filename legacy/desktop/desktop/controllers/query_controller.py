...
from legacy.desktop.application.query_usecases import QueryKnowledgeBaseUseCase, QueryRequest, QueryResponse
from legacy.desktop.desktop.workers.base_worker import WorkerResult
from legacy.desktop.desktop.workers.query_worker import QueryWorker
