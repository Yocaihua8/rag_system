...
- [x] Task 2：补充只读图谱存储查询与红灯测试。
- [x] Task 3：把图谱候选扩展接入 `search_documents()`，并保持 reranker / Qdrant 行为兼容。
...
- **最后更新**：2026-06-29 19:40
- **进度**：已完成 3 / 4 项（见 § 3 勾选状态）
- **最新 commit**：`2e9e8a8` — docs: 启动 B-126 图谱检索计划
- **代码状态**：main；Task 2/3 代码与测试待提交；`tests/test_webapp/test_search.py -q` 已通过
- **下一步**：Task 4：同步正式文档、完成验证、关闭 BACKLOG 并删除本 plan
