...
- **最新 commit**：`7d29b56` — `refactor: 分离后端 API 运行时与依赖`
- **代码状态**：`refactor/repository-structure`；前端 92 项单测、构建、真实跨域 E2E、Tauri/sidecar 验证和 23 项结构契约通过，待阶段提交
- **下一步**：分类测试和工具，删除旧代码、可再生成产物及无引用 1.x 工具
