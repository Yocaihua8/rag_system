...
| B-162 | feature | 持久评估、双层差距与学习计划 | doing | P0 | XL | v2.0.0 | RAG 团队 | docs/features/project-knowledge-coach.md, docs/design/api-spec.md, docs/design/database-design.md | 新增知识点定向评估、项目覆盖/技能差距聚合和可编辑确认的学习计划，保留旧 `/api/assessment/*` 契约。执行计划：`docs/plans/B-162-assessment-coverage-learning-plans.md`。 |
