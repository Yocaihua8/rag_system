...
from legacy.desktop.application.query_usecases import QueryKnowledgeBaseUseCase
from legacy.desktop.application.knowledge_mastery_usecases import KnowledgeMasteryUseCase
from legacy.desktop.application.workspace_usecases import WorkspaceUseCases
from legacy.desktop.desktop.controllers.assessment_controller import AssessmentController
from legacy.desktop.desktop.controllers.ingestion_controller import IngestionController
from legacy.desktop.desktop.controllers.query_controller import QueryController
from legacy.desktop.desktop.controllers.settings_controller import SettingsController
from legacy.desktop.desktop.controllers.workspace_controller import WorkspaceController
...
from legacy.desktop.desktop.views.settings_view import SettingsView
from legacy.desktop.desktop.views.task_status_bar import TaskStatusBar
from legacy.desktop.desktop.views.workspace_view import WorkspaceView
