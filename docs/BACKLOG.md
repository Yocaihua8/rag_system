...
| B-161 | feature | 项目分析、知识点与通用技能映射 | doing | P0 | XL | v2.0.0 | RAG 团队 | docs/features/project-knowledge-coach.md, docs/design/api-spec.md, docs/design/database-design.md | 新增有来源的项目分析、稳定知识点、技能树映射与 Coach 概览 API；Python 和 JS/TS 优先，其他项目使用通用回退。执行计划：`docs/plans/B-161-project-analysis-and-skills.md`。 |
