...
from backend.webapp.answers import compose_answer
from backend.webapp.api_support import project_retrieval_settings, source_quality
from backend.webapp.llm import OpenAICompatibleChatClient
from backend.webapp.model_profiles import llm_config_from_profile
from backend.webapp.models import AgentToolRun, ApiResponse, SearchHit
...
def _openai_compatible_chat_client_class():
    api_module = sys.modules.get("backend.webapp.api")
