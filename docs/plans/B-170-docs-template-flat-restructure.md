...
- **最新 commit**：`8fd1d75` — `docs: 回流功能与运行指南事实`
- **代码状态**：`docs/template-canonical-restructure`；根文档、CI、脚本和仓库契约已更新，旧物理目录已精确清理；等待本阶段提交和最终全量验证。
- **下一步**：提交仓库契约更新，运行最终门禁，移除 B-170 并删除本 plan。
